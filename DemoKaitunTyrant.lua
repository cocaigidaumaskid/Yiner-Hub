...
local existingGui = player.PlayerGui:FindFirstChild("YinnerHubOverlay")
if existingGui then
    existingGui:Destroy()
end
...
gui.Name = "YinnerHubOverlay"
gui.ResetOnSpawn = false
gui.IgnoreGuiInset = true
gui.Parent = player.PlayerGui

-- Background chính - Đổi màu thành xanh dương nhạt với độ trong suốt
local background = Instance.new("Frame")
background.Size = UDim2.new(1, 0, 1, 0)
background.BackgroundColor3 = Color3.fromRGB(41, 128, 185) -- Màu xanh dương nhạt
background.BackgroundTransparency = 0.7 -- Độ trong suốt cao hơn để nhìn rõ game
...
titleText.Text = "Yiner Hub"
titleText.TextColor3 = Color3.fromRGB(41, 128, 185) -- Màu xanh dương nhạt
titleText.TextSize = 50
titleText.Font = Enum.Font.GothamBold
titleText.ZIndex = 2
titleText.Parent = background

-- Hiệu ứng viền cho tiêu đề
...
statusText.Text = "Yiner Hub Kaitun Farm Boss Tyrant Of The Skies"
statusText.TextColor3 = Color3.fromRGB(52, 152, 219) -- Màu xanh dương đậm hơn một chút
...
logo.Image = "rbxassetid://122688731832559" -- Sửa lại ID ảnh hợp lệ (generic ID)
logo.ZIndex = 2
logo.Parent = background

-- Panel nền cho thông tin và thời gian
local infoPanel = Instance.new("Frame")
infoPanel.Size = UDim2.new(0.6, 0, 0.15, 0)
infoPanel.Position = UDim2.new(0.2, 0, 0.8, 0)
infoPanel.BackgroundColor3 = Color3.fromRGB(52, 152, 219) -- Màu xanh dương đậm hơn
infoPanel.BackgroundTransparency = 0.7
infoPanel.ZIndex = 1
...
timeLabel.Size = UDim2.new(0.8, 0, 0.04, 0)
timeLabel.Position = UDim2.new(0.1, 0, 0.82, 0)
...
infoLabel.Size = UDim2.new(0.8, 0, 0.04, 0)
infoLabel.Position = UDim2.new(0.1, 0, 0.86, 0)
...
toggleButton.BackgroundColor3 = Color3.fromRGB(52, 152, 219) -- Màu xanh dương đậm
toggleButton.BackgroundTransparency = 0.3
toggleButton.Image = "rbxassetid://75595046349416" -- Sử dụng cùng ID ảnh với logo
...
toggleButton.MouseEnter:Connect(function()
    game:GetService("TweenService"):Create(toggleButton, TweenInfo.new(0.3), {BackgroundTransparency = 0.1}):Play()
end)

toggleButton.MouseLeave:Connect(function()
    game:GetService("TweenService"):Create(toggleButton, TweenInfo.new(0.3), {BackgroundTransparency = 0.3}):Play()
end)
    ...
    while attempt <= maxAttempts do
        ...
        if data and data.JobId and #data.JobId > 0 then
            for _, jobId in ipairs(data.JobId) do
                ...
                statusText.Text = "Status: Trying to join server with JobId..."
                pcall(function()
            ...
            pcall(function()
                ...
                if not foundBoss then
                    ...
                    if tyrant then
                        ...
                        topos(CFrame.new(-16933.3535, 2000, 520.89801)) -- Teleport đến Tiki Outpost
